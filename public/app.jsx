const HelloMessage = React.createClass({
  render: function() {
    return <div>Hellodsf dsfdsfsdf {this.props.name}</div>
		...
		const mapStateToListProps = (state) => ({todos: getVisibleTodos(state.todos, state.visibilityFilter)})
		const mapDispatchToListProps = (dispatch) => ({onTodoClick: (id) => dispatch(toggleTodo(id))})
		...
		const addTodo = (text) => {return {type: 'ADD_TODO', id: nextTodoId++, text};};
